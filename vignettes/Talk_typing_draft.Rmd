...
The main effect of inner voice condition was significant, `r E1_apa_print$full_result$paragraph`. Mean IKSIs were shorter when subjects were instructed to use their inner voice to say the words (`r printnum(E1_means$tables$paragraph["say_word"], digits=0)`), rather than the letters (`r printnum(E1_means$tables$paragraph["say_letter"], digits=0)`) they were typing.
...
The interaction between inner voice and letter position did not meet the significance criterion, `r E1_apa_print$full_result$paragraph_LetterType`.
